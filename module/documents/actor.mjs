...
export class ShinzoActor extends Actor {
  ...
  _prepareCharacterData(actorData) {
    ...
    const systemData = actorData.system;
      ...
      systemData.gds_statsTotal.value = Math.floor(300 - (gds_stats.con.value + gds_stats.agi.value + gds_stats.men.value + gds_stats.mag.value + gds_stats.cha.value + gds_stats.sav.value))
