...
export class ShinzoActor extends Actor {
  ...
  _prepareCharacterData(actorData) {
    ...
    const systemData = actorData.system;
      ...
      ss_stat1.pug.value = Math.floor((2*gds_stats.con.value + maitrise.cor.value) / 3 + ss_stat1.pug.b_m);
      ss_stat1.cac.value = Math.floor((gds_stats.con.value + 2*maitrise.cor.value) / 3 + ss_stat1.cac.b_m);
      ss_stat1.pre.value = Math.floor((maitrise.esp.value + 3*maitrise.cor.value) / 4 + ss_stat1.pre.b_m);
      ss_stat1.esq.value = Math.floor((maitrise.cor.value + 2*gds_stats.agi.value) / 3 + ss_stat1.esq.b_m);
      ss_stat1.par.value = Math.floor(maitrise.cor.value + ss_stat1.par.b_m);
      ss_stat1.dis.value = Math.floor((maitrise.soc.value + 2*gds_stats.agi.value) / 3 + ss_stat1.dis.b_m);
      ss_stat1.obs.value = Math.floor((maitrise.soc.value + 3*gds_stats.men.value) / 4 + ss_stat1.obs.b_m);
      ss_stat1.per.value = Math.floor((maitrise.esp.value + 3*gds_stats.mag.value) / 4 + ss_stat1.per.b_m);
      ss_stat1.psy.value = Math.floor((gds_stats.mag.value + gds_stats.men.value + 2*maitrise.esp.value) / 4 + ss_stat1.psy.b_m);
      ss_stat1.int.value = Math.floor((gds_stats.con.value + 2*maitrise.soc.value) / 3 + ss_stat1.int.b_m);
      ss_stat2.com.value = Math.floor(maitrise.soc.value + ss_stat2.com.b_m);
      ss_stat2.aut.value = Math.floor((maitrise.soc.value + gds_stats.cha.value) / 2 + ss_stat2.aut.b_m);
      ss_stat2.med.value = Math.floor((gds_stats.sav.value + maitrise.esp.value) / 2 + ss_stat2.med.b_m);
      ss_stat2.pil.value = Math.floor((maitrise.soc.value + maitrise.esp.value) / 2 + ss_stat2.pil.b_m);
      ss_stat2.art.value = Math.floor((maitrise.soc.value + maitrise.esp.value) / 2 + ss_stat2.art.b_m);
      ss_stat2.vit.value = Math.floor((gds_stats.agi.value + maitrise.cor.value) / 2 + ss_stat2.vit.b_m);
      ss_stat2.ins.value = Math.floor((gds_stats.men.value + maitrise.esp.value) / 2 + ss_stat2.ins.b_m);
      ss_stat2.s_f.value = Math.floor((gds_stats.sav.value + maitrise.esp.value) / 2 + ss_stat2.s_f.b_m);
